...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton(" Movie", url="https://t.me/moveiessponchpop"),
                InlineKeyboardButton("Series ", url="https://t.me/moveiessponchpop")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(' Series & Movie Club ', url=f'https://t.me/moveiessponchpop')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Movie Club ', url='https://t.me/moveiessponchpop')
            ],[
